...
=======
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
      <h3 className="text-2xl font-bold text-white mb-4">User Ratings</h3>
      <div className="flex items-center mb-4">
        <span className="text-4xl font-bold text-yellow-400 mr-2">{averageRating.toFixed(1)}</span>
>>>>>>> Stashed changes
        <div className="flex">
          {[1, 2, 3, 4, 5].map((star) => (
            <svg
...
=======
              className={`w-6 h-6 ${averageRating >= star ? 'text-yellow-400' : 'text-gray-400'}`}
>>>>>>> Stashed changes
              fill="currentColor"
              viewBox="0 0 20 20"
...
=======
        <span className="ml-2 text-gray-300">({ratings.length} reviews)</span>
      </div>
      
      <div className="mb-4">
        <h4 className="text-white mb-2">Rate this game:</h4>
        <div className="flex">
>>>>>>> Stashed changes
          {[1, 2, 3, 4, 5].map((star) => (
            <button
            ...
            <div className="flex items-center mb-2">
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg
                    key={star}
                    className={`w-5 h-5 ${rating.rating >= star ? 'text-yellow-400' : 'text-gray-400'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <span className="ml-2 text-gray-300">by {rating.user.username}</span>
            </div>
