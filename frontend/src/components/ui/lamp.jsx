  ...
  return (
    (<LampContainer>
      <motion.h1
        ...
        className="font-primaryRegular mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl S tracking-tight text-transparent md:text-7xl">
        Vortex Gaming <br /> Where Every Battle Begins a New Adventure.
      </motion.h1>
    </LampContainer>)
  );
}
