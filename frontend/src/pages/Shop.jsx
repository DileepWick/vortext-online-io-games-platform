      ...
      <ScrollShadow hideScrollBar>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {filteredStocks.length === 0 ? (
            ...
            <div className="flex flex-wrap justify-center gap-8"> {/* Adjusted gap */}
              {filteredStocks.map((stock) => {
                ...
                return (
                  <Card
                    key={stock._id}
                    className="relative bg-black rounded-lg shadow-lg text-white transform transition-transform duration-300 hover:scale-105 hover:z-10 hover:shadow-2xl hover:bg-opacity-80 w-[250px] h-[500px]">
                    ...
                    <Link to={`/game/${stock._id}`}>
                      ...
                      <CardBody className="p-2 text-white"> {/* Reduced padding */}
                        ...
                        <div className="flex flex-wrap mb-1 text-white">
                          {stock.AssignedGame.Genre.flatMap((genre) =>
                            ...
                            <Chip variant="dot" size="sm" radius="none" className="font-primaryRegular" color="danger" key={index}>
                              {(() => {
                                const genreName =
