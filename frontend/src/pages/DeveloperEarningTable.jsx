...
const DeveloperIncomeTable = () => {
  ...
  return (
    <div>
      <div ref={componentRef} className="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-4 flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">{profileData.email.split('@')[0]}</h2>
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-lg font-semibold">Rs. {profileData.developerAttributes.income.toLocaleString()}</span>
            </div>
          </div>
          <div className="mt-6">
            ...
            <p className="text-center text-sm text-gray-500 mt-2">Income Visualization</p>
          </div>
        </div>
      </div>
