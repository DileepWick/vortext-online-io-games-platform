...
const UserManagementDashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchModerators = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/moderators/allmoderators`
        );
    ...
    const fetchDevelopers = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/developers/requests`);
      ...
      <div className="flex items-center p-4 font-primaryRegular">
        ...
        >
          <Tab
            ...
            style={{ padding: "20px 30px", fontSize: "1.1rem" }}
          />
          <Tab
            key="tab2"
            title="Manage Users"
